...
## The Hierarchy of Response Goals (in order of priority)
...
Your opening reply must **begin reversing this asymmetry**. Ask questions that expose their constraints without revealing yours.
...
|--------|------------|---------------------|
| **Ethos** (Credibility) | Your professional authority | One-line proof point — a result, a title, a context that makes you irreplaceable |
| **Pathos** (Emotion) | Tactical empathy | Acknowledge their goal/pain before pivoting to your needs |
| **Logos** (Logic) | Objective data | Reference a benchmark, market reality, or specific number when it serves you |
| **Kairos** (Timing) | Mastering the tempo | Match response speed and commitment level to where *they* are, not where you want to be |

A strong reply doesn't need all four — it needs the right one for the moment.

---

## Response Variation Dimensions

When generating 10 responses, vary meaningfully across:

1. **Information extracted** — How aggressively does this reply probe for their constraints?
2. **Commitment level** — From zero commitment (just acknowledging) to soft commitment (next step contingent on info)
3. **Power dynamic** — From collaborative peer to selective evaluator to politely disinterested
4. **Length** — Short (1 sentence), medium (2-3 sentences), fuller (1 paragraph)
5. **Tone** — Warm/curious, direct/evaluative, professional/formal, playful/brief, polite decline
...
**Their position:** They have more urgency and authority than a recruiter. Reaching out directly signals genuine pain.
...
**Their position:** They need something from you. You have all the power.

**Your goal:** Screen efficiently. If interesting, extract maximum information before any commitment.

**Rules:**
- If irrelevant: polite, brief decline — no explanation needed
- If potentially relevant: ask for specific outcomes data and reference clients before any call
- Never agree to a "quick demo" — agree to a written summary first

### Networking / Peer Connection

**Their position:** Likely genuine. Lower stakes.

**Your goal:** Warm, genuine engagement. Still prefer async.

**Rules:**
- Open to short async exchanges
- For deeper asks (advice, intros, mentorship), require more specificity before committing time
- For paid advisory/consult requests: surface a structure rather than doing it free

### Requests for Advice or Help

**Their position:** They want your expertise for free.

**Your goal:** Help selectively; don't let this become a pattern.
...
## Phrases That Signal Premium Positioning

- "Before we go further, can you share..." (anchors the next step to their action)
- "I'm selective about what I take on..." (signals demand)
- "What specifically drew you to my background?" (reverses the power dynamic)
- "Let me understand the scope before committing to next steps" (controls timeline)
